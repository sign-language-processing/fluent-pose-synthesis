...
CONFIGS: dict[str, StitchConfig] = {
    ...
    "fluent": StitchConfig(anonymize=True, drop_inactive_hands=True, trim_method="segmentation",
                           padding=0.05, reduce_holistic=False, butter=True, butter_cutoff=6.0,
                           max_sign_frames=40),
    # Keep the citation length (~1.5x) but still de-jittered and semantically closer.
    "fluent_long": StitchConfig(anonymize=True, drop_inactive_hands=True, trim_method="segmentation",
                                padding=0.05, reduce_holistic=False, butter=True, butter_cutoff=7.0),
}
